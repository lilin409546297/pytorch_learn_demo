...
def cnn_train():
    ...
    # 3、训练
    if os.path.exists("./model/lenNet5.pkl"):
        net.load_state_dict(torch.load("./model/lenNet5.pkl"))
    ...
    for num in range(100):
        ...
        if not os.path.exists("./model"):
            os.mkdir("./model")
        torch.save(net.state_dict(), "./model/lenNet5.pkl")
...
def cnn_test():
    ...
    for cifar_test_data, cifar_test_target in cifar_test:
        ...
        predict_true =torch.eq(predict, cifar_test_target).sum().item()
